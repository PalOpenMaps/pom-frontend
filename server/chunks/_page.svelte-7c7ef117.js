import { c as create_ssr_component, g as getContext, a as subscribe, e as escape, b as add_attribute, v as validate_component, f as add_styles } from './index2-d563acd4.js';
import { b as base } from './paths-05fee424.js';
import { a as cdnBase } from './config-4128fe2f.js';
import { S as Select_1 } from './Select-faaed054.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  $$unsubscribe_rtl();
  return `${$$result.head += `<!-- HEAD_svelte-1l3xi7k_START -->${$$result.title = `<title>${escape($t("Palestine Open Maps"))}</title>`, ""}<meta property="og:title"${add_attribute("content", $t("Palestine Open Maps"), 0)}><meta property="og:image" content="${escape(cdnBase, true) + "/assets/img/haifa-crop.jpg"}"><!-- HEAD_svelte-1l3xi7k_END -->`, ""}
...
//# sourceMappingURL=_page.svelte-7c7ef117.js.map
