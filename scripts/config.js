...
export const locs_path = "./raw-data/locs.csv";
export const places_path = "./static/data/places.json";
export const redirect_path = "./static/data/redirects.csv";
export const layers_path = "./static/data/layers.json";
export const sheets_path = "./static/data/sheets.json";
